...
@app.get("/contact")
def contact():
    """صفحة التواصل مع فريق مشروع المعاين الذكي."""

    students = [
        {
            "name": "سعد راشد لخالدي",
            "city": "االمنطقة الشرقية",
        },
        {
            "name": "عبدالرزاق عياط العنزي",
            "city": "حفر الباطن",
        },
        {
            "name": "ساهر سلطان الخيبري",
            "city": "المدينة المنورة",
        },
        {
            "name": "سيف عبدالعزيز الدرويش",
            "city": "الزلفي",
        },
        {
            "name": "إياد أنور القرشي",
            "city": "جدة",
        },
    ]
